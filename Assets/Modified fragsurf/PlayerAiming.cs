...
public class PlayerAiming : MonoBehaviour
{
	...
	public Vector2 lastMouseMovements = Vector2.zero;

	public void Look(InputAction.CallbackContext context) {
		lastMouseMovements += context.ReadValue<Vector2>();
	}
	...
	private void Update()
	{
		...
		// Input
		float xMovement = lastMouseMovements.x * horizontalSensitivity * sensitivityMultiplier;
		float yMovement = -lastMouseMovements.y * verticalSensitivity  * sensitivityMultiplier;
		lastMouseMovements = Vector2.zero;
