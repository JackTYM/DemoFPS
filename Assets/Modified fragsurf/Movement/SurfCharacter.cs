    ...
    public class SurfCharacter : MonoBehaviour, ISurfControllable {
        ...
        private void Start () {
            ...
            switch (collisionType) {
                ...
                _colliderObject.AddComponent<PlayerController>();
        ...
        public void Move(InputAction.CallbackContext context) {
            _moveData.verticalAxis = context.ReadValue<Vector2>().y;
            _moveData.horizontalAxis = context.ReadValue<Vector2>().x;
        }

        public void Sprint(InputAction.CallbackContext context) {
            _moveData.sprinting = context.performed || !context.canceled;
        }

        public void Crouch(InputAction.CallbackContext context) {
            _moveData.crouching = context.performed || !context.canceled;
        }

        public void Jump(InputAction.CallbackContext context) {
            _moveData.wishJump = context.performed || !context.canceled;
        }
